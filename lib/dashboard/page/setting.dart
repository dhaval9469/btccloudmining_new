              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    20.heightBox,
                    SlideFadeTransition(index: 8, child: BigNativeS()),
                    40.heightBox,
                  ],
                ),
              ),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                ...
                fit: BoxFit.cover,
                colorFilter: ColorFilter.mode(AppColor.subText, BlendMode.srcIn),
              ),
            ),
          ),
          10.widthBox,
          Text(text ?? '', style: textRoboto(context, fontSize: 15, color: AppColor.subText)),
          Spacer(),
          Icon(CupertinoIcons.right_chevron, color: AppColor.subText, size: 18),
        ],
      ),
    );
  }
        ...
        return SafeArea(
          child: Container(
            ...
            child: Column(
              ...
              children: [
                10.heightBox,
                Text('sruf'.tr, style: textMontserrat(context, fontWeight: FontWeight.w600, fontSize: 16)),
                12.heightBox,
                Text('srufText'.tr, textAlign: TextAlign.center, style: subTextRoboto(context, fontSize: 13)),
                15.heightBox,
                RatingBar.builder(

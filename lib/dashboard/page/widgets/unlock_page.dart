                  ...
                  child: Column(
                    children: [
                      SlideFadeTransition(
                        ...
                        child: Stack(
                          ...
                          children: [
                            ...
                            Lottie.asset(AppAsset.lockLoader, height: context.responsive.heightPercent(20)),
                          ],
                        ),
                      ).py(40),
                      SlideFadeTransition(
                      ...
                      SlideFadeTransition(
                        index: 3,
                        child: Text(
                          "lUPsc".trParams({"unlockbtc": balance.toStringAsFixed(12)}),
                      ...
                      SlideFadeTransition(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            showWatchLockDialog(
                              context,
                              text: "lUPtl".trParams({"tounlockbtc": balance.toStringAsFixed(12)}),
                              onWatchAd: () {
                                handleLockTap();
                              },
                            );
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(text, textAlign: TextAlign.center, style: subTextMontserrat(context, fontSize: 13)),
    ...
    IntOrRwdAdManger().showIntORRwdAdOnPlanAd(
      ...
      onAdClosed: () {
        showSuccessDialog(
          context,
          isEmpty: false,
          massage: "lUPbsm".trParams({"unlockedbtc": balance.toStringAsFixed(12)}),
          onTap: () {
            Navigation.pop();
          },
        );

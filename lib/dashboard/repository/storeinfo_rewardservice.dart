...
class StoreInfoAdRewardService {
  static final StoreInfoAdRewardService _instance = StoreInfoAdRewardService._internal();

  factory StoreInfoAdRewardService() => _instance;

  StoreInfoAdRewardService._internal();

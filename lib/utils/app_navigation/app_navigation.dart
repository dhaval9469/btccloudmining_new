...
import 'package:btccloudmining/dashboard/page/widgets/lock_page.dart';
...
mixin Routes {
  ...
  static List<GetPage<dynamic>> routes = [
    ...
    GetPage(
      name: viewActiveAsics,
      page: () => const ViewActiveAsics(),
    ...
    GetPage(
      name: signInRewardPage,
      page: () => const SignInRewardPage(),
      transition: defaultTransition,
    ),
